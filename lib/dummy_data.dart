...
var dummyCollections = {
    ...
    "sheetBottomRow":16,
    "fields": {
      "id":{"fieldName": "id","displayName": "id",  "type": "UniqueKey", "sheetColumn":2},	
      "name":{"type": "String","sheetColumn":3},
      "type":{"fieldName": "type","displayName": "type","type": "String","sheetColumn":4},	
      "isSite":{"fieldName": "isSite","displayName": "isSite","type": "bool","sheetColumn":5},
      "isDownload":{"fieldName": "isDownload","displayName": "isDownload","type": "bool","sheetColumn":6},	
      "isImage":{"fieldName": "isDownload","displayName": "isDownload","type": "bool", "sheetColumn":7},
      "url":{"fieldName": "url","displayName": "url","type": "String","sheetColumn":8},
      "description":{"fieldName": "description","displayName": "description","type": "String","sheetColumn":9},
      "show":{"fieldName": "show","displayName": "show","type": "bool","sheetColumn":10},
    },
    "models": {
      
        "id1":{"id":"id1","name":"Prusa Design","isSite":false, "isDownload":false, "isImage":true, "url":"https://media.prusaprinters.org/thumbs/cover/1200x630/media/prints/27950/images/279325_253e1b16-a093-49be-91fc-94f9d58f6cf5/3_pins.jpg", "description":"", "show":true},
        "id2":{"id":"id2", "isSite":true, "isDownload":false, "isImage":false, "url":"https://www.prusaprinters.org/prints/28504-slim-rc3-us-with-comfort-features-plus-shield", "description":"", "show":true},
        "id3":{"id":"id3", "isSite":false, "isDownload":true, "isImage":false, "url":"https://media.prusaprinters.org/media/prints/28504/stls/283479_de0889c1-5758-486b-801d-b8d4beef5b06/covid19_headband_rc3us_slim-nologo.stl#_ga=2.49263974.131473350.1586915350-468789971.1584729672", "description":"", "show":true},
        "id4":{"id":"id4", "isSite":false, "isDownload":false, "isImage":false, "url":"", "description":"", "show":true},
        "id5":{"id":"id5",  "isSite":false, "isDownload":false, "isImage":false, "url":"", "description":"", "show":true},
        "id6":{"id":"id6","name":"3DVerkstan Design", "isSite":false, "isDownload":false, "isImage":true, "url":"https://cdn.myminifactory.com/assets/object-assets/5e8d747938361/images/720X720-img-20200408-083219749.jpg", "description":"", "show":true},  
    }
},
  "orgs":{
    "modelName": "Org",
    ...
    "fields": {
      ...
      "RequestsList":{"type": "List-ForeignKey","typeInfo":"requests","sheetColumn":14},	
  ...
  "designs":{
    ...
    "fields": {
      ...
      "resources":{"type": "List-ForeignKey","typeInfo":"resources","sheetColumn":4},
  ...
  "requests":{
    ...
    "fields": {
      "id":{"fieldName": "id","displayName": "id",  "type": "UniqueKey","sheetColumn":2},	
      "designID":{"type": "ForeignKey", "typeInfo":"designs","sheetColumn":3},	
      ...
      "claimsList":{"type": "List-ForeignKey","typeInfo":"claims","sheetColumn":16},
},
    "models": {
      "req1":{"id":"req1", 
      "designID":"earsaver", 
  ...
  "userupdates":{
    ...
    "fields": {
      ...
      "designID":{"type": "ForeignKey", "typeInfo":"designs","sheetColumn":4},
    ...
    "models": {
      ...
      "claimID":"claim1",
      "quantity":40,
      "photourl":"https://firebasestorage.googleapis.com/v0/b/twitter-clone3.appspot.com/o/images%2Fshipley_manor_delivery.jpg?alt=media&token=2ae36d88-327a-4451-add2-4ae94cccf101",
      },
            "update2":{
      "id":"update2",	
      "userid":"Tkz01qVV6Zbn8PXCJMVibjihuA23",	
      "designID":"faceshield",
      "quantity":60,
      "photourl":"https://firebasestorage.googleapis.com/v0/b/twitter-clone3.appspot.com/o/images%2Fdrop_off_042020_1.jpg?alt=media&token=275004c8-b7a0-4b61-a4da-1de500c25f93",
      }
    ...
    "fields": {
      ...
      "requestID":{"type": "ForeignKey", "typeInfo":"requests","sheetColumn":4},
      "designID":{"type": "ForeignKey", "typeInfo":"designs","sheetColumn":5},
      "userID":{"type": "ForeignKey", "typeInfo":"users","sheetColumn":6},
      "updateID":{"type": "ForeignKey", "typeInfo":"userupdates","sheetColumn":7},
  ...
  "groups":{
    ...
    "fields": {
      ...
      "updates":{"type": "List-ForeignKey","typeInfo":"userupdates","sheetColumn":8},
      "numMembers":{"type": "int","sheetColumn":9},
      "userList":{"type": "List-ForeignKey","typeInfo":"users","sheetColumn":10},
      "targetPopulation":{"type": "String","sheetColumn":11},
      "resources":{"type": "List-ForeignKey","typeInfo":"resources","sheetColumn":12},
      "approvedDesigns":{"type": "List-ForeignKey","typeInfo":"designs","sheetColumn":13},
