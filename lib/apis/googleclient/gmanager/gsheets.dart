...
class Spreadsheet {
  ...
  Future<Worksheet> addWorksheet(
    ...
    check('rows', rows);
    final response = await GManager.batchUpdate(_client, id, [
      {
        'addSheet': {
          'properties': {
            'title': title,
  ...
  Future<Worksheet> copyWorksheet(
    ...
    final duplicate = Worksheet.fromJson(
  ...
  Future<bool> deleteWorksheet(Worksheet ws) async {
    await GManager.batchUpdate(_client, id, [
      {
...
class Worksheet {
  ...
  Future<bool> updateTitle(String title) async {
    ...
    await GManager.batchUpdate(_client, spreadsheetId, [
      {
  ...
  Future<bool> _expand(int rows, int cols) async {
    ...
    if (changed) {
      final response = await GManager.batchUpdate(_client, spreadsheetId, [
        {
          'updateSheetProperties': {
            'properties': {
              'sheetId': id,
